...
/* 4th order Runge Kutta solver with adaptive step sizing. The 'disable' flag disables adaptivity */
double rk4(void *model, double *y, void *p, int n, double *h, double *yout, slope_fn_ptr f, int disable);
