...
\begin{document}
  % \conferenceinfo{DAC'12,}{ June 03--07, 2012, San Francisco, CA, USA}
  % \CopyrightYear{2012}
  % \crdata{978-1-4503-1199-1/12/06}

  \conferenceinfo{DAC'12,}{June 3--7, 2012, San Francisco, California, USA.}
  \CopyrightYear{2012}
  \crdata{978-1-4503-1199-1/12/06}
  ...
  % Capitalized
  \vspace{-5pt}
  \keywords{Multiprocessor System, Periodic Power Profile, Temperature Analysis, Leakage Power, Thermal Cycling Fatigue.}
