In the onwards explanation without loss of generality we assume $T(t) \equiv T(t) - T_{amb}$. Let the power consumption vector $P(t)$ be constant and equal to $P$, then the system given by \equref{eq:fourier-model} is a system of ordinary differential equations with the following solution:
