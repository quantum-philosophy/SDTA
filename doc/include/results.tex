...
\begin{itable}{mttf-tasks}{|r|r|r|r|r|}
  ...
  $N_p$ & $N_t$ & $t_{avg}, m$ & $MTTF_{avg}$, $\times$ & $E_{avg}$, $\times$ \\
  \hline
  4 &  20 & \todo{ 0.93} & \todo{13029.86} & \todo{0} \\
  4 &  40 & \todo{ 1.81} & \todo{ 4311.02} & \todo{0} \\
  4 &  80 & \todo{ 4.98} & \todo{ 2358.82} & \todo{0} \\
  4 & 160 & \todo{10.40} & \todo{  912.70} & \todo{0} \\
  4 & 320 & \todo{29.77} & \todo{  481.67} & \todo{0} \\
  \hline
\end{itable}
