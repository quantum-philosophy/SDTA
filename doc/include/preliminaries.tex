...
A example of a simplistic equivalent RC thermal circuit for a dual-core system is depicted in Figure [\todo{Draw the circuit}]. It can be seen that the inter-core dependency is taken into account by modeling heat flux between the cores with corresponding thermal resistances.
