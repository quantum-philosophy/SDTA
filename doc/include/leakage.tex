...
\end{align*}
Therefore, all solutions proposed in this paper are valid with the linearized leakage model with no additional costs. Moreover, in spite of its simplicity, the approximation provides a good estimation as it is shown in \cite{liu2007}.
